...
var handleSubmit = function handleSubmit(event) {
  ...
  var key_one = crypto__WEBPACK_IMPORTED_MODULE_1___default().randomBytes(256).toString("hex").substr(100, 5);
  var key_two = crypto__WEBPACK_IMPORTED_MODULE_1___default().randomBytes(256).toString("hex").substr(50, 5);
